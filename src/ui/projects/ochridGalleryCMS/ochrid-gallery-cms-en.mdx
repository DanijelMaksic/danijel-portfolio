...
This is the internal application of the public webstore "Ochrid Gallery". This is the closed-off app that only selected employees of the business have access to. It is an SPA powered by React, providing the user with fast navigation. The app's data is stored in the Supabase database. Deployed on Vercel.
...
Upon logging in, the user will see the dashboard page, which contains all the relevant
information and statistics about the business. Here the user can also access the incoming
...
The first major part of the application is the inventory management. On this page the user can add a new icon to the inventory.
...
In the details page of the specific order, all the information about said order will be displayed in an easy-to-read manner. On this page the user can choose to archive (confirm and complete) the order. Archiving the order will update the inventory and the dashboard stats.
...
The final page is the update account page, where the user can edit account information or password.
