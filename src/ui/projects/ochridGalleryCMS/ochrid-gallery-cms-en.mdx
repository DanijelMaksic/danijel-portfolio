...
This is the internal application of the public webstore "Ochrid Gallery". This is the closed-off app that only selected employees of the business have access to. It is an SPA powered by React, providing user with fast navigation. The app's data is stored in the Supabase database. Deployed on Vercel.
