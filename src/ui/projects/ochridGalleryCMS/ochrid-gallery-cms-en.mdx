...
This is the internal application of the public web store "Ochrid Gallery". This is the closed-off app that only selected employees of the business have access to. It is an SPA powered by **React**, providing user with fast navigation.
